...
import DescentMap from "./DescentMap";
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-10">
      ...
      <div className="relative grid w-full max-w-6xl gap-6 lg:grid-cols-[minmax(0,1.1fr)_380px]">
        <section className="panel-shell flex flex-col gap-8">
          <div>
            ...
            >
              <span style={{ color: "var(--accent-gold)" }}>던전</span>{" "}
              <span style={{ color: "var(--text-primary)" }}>TRPG</span>
            </h1>
            <p
              className="mt-4 max-w-2xl text-base leading-8 [text-wrap:pretty]"
        ...
        <aside className="panel-shell">
          {hasSave ? (
            ...
            >
              ...
              <p className="mt-2 text-xs leading-5" style={{ color: "var(--text-muted)" }}>
                이어가려면 Gemini API 키를 입력하세요. 키는 저장되지 않습니다.
              </p>
              <button
                type="button"
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <div>
              ...
              />
              <p className="mt-2 text-xs leading-5" style={{ color: "var(--text-muted)" }}>
                키는 이 세션의 메모리에만 보관되며, Gemini API 호출을 위해서만 서버로 전송됩니다.
              </p>
            </div>
            <button
              type="submit"
